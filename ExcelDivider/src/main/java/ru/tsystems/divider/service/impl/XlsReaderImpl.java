...
public class XlsReaderImpl implements ExcelFileReader {

    private final FileInputStream fileInputStream;

    private final HSSFWorkbook xlsxWorkbook;

    private HSSFSheet xlsxShet;

    public XlsReaderImpl(String xlsxFilePath, String xlsxSheetName) throws IOException {
        this(xlsxFilePath);
        this.xlsxShet = xlsxWorkbook.getSheet(xlsxSheetName);
    }

    public XlsReaderImpl(String xlsxFilePath) throws IOException {
        this.fileInputStream = new FileInputStream(xlsxFilePath);
        this.xlsxWorkbook = new HSSFWorkbook(fileInputStream);
    }
